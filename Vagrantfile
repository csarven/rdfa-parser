...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  # Share an additional path to the guest VM. The first argument is
  # the path on the host to the actual path. The second argument is
  # the path on the guest to mount the path. And the optional third
